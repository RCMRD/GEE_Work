...
var Forestland = /* color: #008000 */ee.Geometry.MultiPoint(),
    ...
    UG = ee.FeatureCollection("users/firsake/gadm36_UGA_0");
...
var drawReference = function() {
  var lc2000s1 = ee.Image("users/yang/EastAfrica/Uganda_Landcover_2000_Scheme_I").rename('landcover')
  var lc2014s1 = ee.Image('users/yang/EastAfrica/Uganda_Landcover_2014_Scheme_I').rename('landcover')

  Map.addLayer(lc2000s1, visS1, 'RCMRD 2000', false)
  Map.addLayer(lc2014s1, visS1, 'RCMRD 2014', false)
}
...
Map.centerObject(ee.Geometry.Point([32.409, 1.384]), 6)
