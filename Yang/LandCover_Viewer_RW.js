...
var Forestland = /* color: #008000 */ee.Geometry.MultiPoint(),
    ...
    RW = ee.FeatureCollection("projects/servir-e-sa/rwanda_ludss/RCMRD/Rwanda_shp");
...
var drawReference = function() {
  var lc1990s1 = ee.Image('users/yang/EastAfrica/Rwanda_Landcover_1990_Scheme_I').rename('landcover')
  var lc2000s1 = ee.Image('users/yang/EastAfrica/Rwanda_Landcover_2000_Scheme_I').rename('landcover')
  var lc2010s1 = ee.Image('users/yang/EastAfrica/Rwanda_Landcover_2010_Scheme_I').rename('landcover')

  Map.addLayer(lc1990s1, visS1, 'RCMRD 1990', false)
...
Map.centerObject(ee.Geometry.Point([29.87, -1.935]), 6)
